...
from .util import scan, snmp
from monitoramento_impressoras_agente.loggin import log_info, log_error
...
#ScanResult = list[SnmpResult]


async def colect_snmp(ip: str, branch_id: int, network_id: int | None) -> SnmpResult:
        """Versão 100% assincrona da coleta individual"""
